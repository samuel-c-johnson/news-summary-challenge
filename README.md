The purpose of the challenge was to build a single page web app using javascript and html. The app was to display headlines using the Guardian news API which could be clicked on to reveal the full news story.
I did not manage to complete the challenge largely due to not being able to understand how to use the API. I will complete this challenge once I know how to use it.
...
The static web server used(e.g. [http-server](https://www.npmjs.com/package/http-server)) to serve your HTML, CSS and JavaScript files.  You'll send requests to an API to get data from the Guardian and to summarise text.
